...
<?php
	...
	foreach ($configFile as $line_num => $line) {
		switch (substr($line,0,16)) {
			case "define('DB_NAME'":
        $configFile[$line_num] = str_replace("veritabaniismi", $dbname, $line); 
				break;
			case "define('DB_USER'":
        $configFile[$line_num] = str_replace("'kullaniciadi'", "'$uname'", $line);
				break;
			case "define('DB_PASSW":
        $configFile[$line_num] = str_replace("'parola'", "'$passwrd'", $line);
				break;
			case "define('DB_HOST'":
