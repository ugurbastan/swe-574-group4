...
<li><span><?php if(get_the_author_meta('home_phone_number') != ''){ _e('Ev Telefonu:','appthemes');} ?></span> <?php echo get_the_author_meta('home_phone_number'); ?></li>
<li><span><?php if(get_the_author_meta('work_phone_number') != ''){ _e('İş Telefonu:','appthemes');} ?></span> <?php echo get_the_author_meta('work_phone_number'); ?></li>
<li><span><?php if(get_the_author_meta('cell_phone_number') != ''){ _e('Cep Telefonu:','appthemes');} ?></span> <?php echo get_the_author_meta('cell_phone_number'); ?></li>
