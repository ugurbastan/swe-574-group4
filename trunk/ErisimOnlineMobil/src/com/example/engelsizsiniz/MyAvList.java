...
public class MyAvList extends ListActivity {
    ...
    private static String url_all_my_av = "http://swe.cmpe.boun.edu.tr/fall2012g4/get_all_my_AV.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        myAvList = new ArrayList<HashMap<String, String>>();
    ...
    class LoadAllProducts extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            Log.d("All my Av List: ", json.toString());
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            MyAvList.this, myAvList,
                            R.layout.list_av_item, new String[] { TAG_PID,
                                    TAG_NAME},
